import stls from '@/styles/components/liveCourses/LiveCoursesForm.module.sass'
import Wrapper from '../layout/Wrapper'
import ImgEntryForm from '../imgs/general/ImgEntryForm'
import LivePaymentForm from '../forms/LivePaymentForm'
              ...
              <div className={stls.card}>
                <div className={stls.topWhiteBlock}>
                  <div className={stls.topWhiteLeft}>
                    ...
                    <p className={stls.newPrice}>{program.price ?? '10.000'} ₽</p>
                  </div>
            ...
            <div className={stls.leftBlock}>
              <div className={stls.form}>
                <div className={stls.bgForm}>
                  <p>
                    Заполни форму, чтобы получить доступ к курсу
                  </p>
                  <LivePaymentForm isLiveCourse cta={'И разобраться с обидами'} program={program}/>
