import StudyCabinet from '@/components/imgs/general/StudyCabinet'
...
const CommonAboutSlider = () => {
  ...
  return (
    <div className={stls.container}>
      ...
      <LeftPanel currentIndex={currentIndex} component={slideComponents}
        onArrowClick={handleArrowClick} />
      <RightPanel imageUrl={contentData[currentIndex].imageUrl}
