...
const Faq = ({faqRef=null}) => {
  ...
  let list =
    ...
    const listOnMain = [
      ...
      {question:'Какие в MIP есть варианты оплаты?', answer: 'Вы можете оплатить полную стоимость сразу или воспользоваться рассрочкой от Института или банка партнера.'},
