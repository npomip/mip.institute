...
const Faq = ({faqRef=null}) => {
  ...
  let list =
    ...
    const listOnMain = [
      ...
      {question:'Нужно ли медицинское образование для поступления по программам вашего института?', answer: '<p>Нет. Психолог — не врач. Он не проводит сложные терапии, не назначает стационарное или медикаментозное лечение </p>'},
      ...
      {question:'Какие в MIP есть варианты оплаты?', answer: '<p>Вы можете оплатить полную стоимость сразу или воспользоваться рассрочкой от Института или банка партнера.</p>'},
