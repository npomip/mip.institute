...
{/* // added in NY */}
        ...
        <div className={stls.content}>
          ...
          {/* // added in NY  */}
          {/* <p>
            <span>Ваши данные переданы в приемную комиссию,</span> Время ответа/звонка приемной комиссии в праздничные дни может быть увеличено. Пока вы ждете, рекомендуем забрать пользу в нашем телеграм-канале института, так время ожидания пролетит незаметно.
          </p> */}
          {/* // added in NY  */}
        </div>
      </div>
