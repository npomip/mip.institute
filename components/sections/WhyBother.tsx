...
const WhyBother = () => {
  const points=[{title:'Востребованность', desc:'С начала 2023 года ТАСС зафиксировал рост обращений к психологам на 15%'},{title:'Экологичная профессия', desc:'Психолог — тот человек, который несет пользу окружающим, помогает справиться с психологическими проблемами и кризисами '},{title:'Удаленный график', desc:'Можно работать дистанционно из любой точки мира '},{title:'Высокий доход', desc:'Средняя зарплата наших выпускников 80 000 р.* ', subdesc:<>*Средняя стоимость консультации выпускников МИП — 3 000 р./час <br /> Занятость — 1-2 ч./ день. Доход — 60-120 000 р./мес</>}]
  return (
