...
import stls from '@/components/sections/practicalTraining/PracticalWhatYouWillLearn/PracticalWhatYouWillLearnItem/PracticalWhatYouWillLearnItem.module.sass'
