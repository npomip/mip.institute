...
const dataDocsRegulationsRight: TypeDataDocs = [
  {
    href: `${routes.front.docsRegulations}/prikaz-9-ot-14-01-2013-gh-o-komissii-ministierstva-obrazovaniia-i-nauki-rf-po-razvitiiu-dopolnitiel-nogho-profiessional-nogho-obrazovaniia.pdf`,
  ...
  {
    href: `${routes.front.docsRegulations}/poriadok-orghanizatsii-i-osushchiestvlieniia-obrazovatiel-noi-dieiatiel-nosti-po-dopolnitiel-nym-profiessional-nym-proghrammam-utv-prikazom-ministierstva-obrazovaniia-i-nauki-rf-ot-1-iiulia-2013-gh-499.pdf`,
  ...
  {
    href: `${routes.front.docsRegulations}/raziasnieniia-o-zakonodatiel-nom-i-normativnom-pravovom-obiespiechienii-dopolnitiel-nogho-profiessional-nogho-obrazovaniia-diepartamient-ghosudarstviennoi-politiki-v-sfierie-rabochikh-kadrov-i-dpo.pdf`,
