    ...
    <>
      ...
      <Wrapper>
              ...
              <div className='ym-product'>
                <div className='ym-product-line'>
                  <span className='ym-product-description'>
                    <span className='ym-product-count'>1×</span>Образовательная
                    услуга
                  </span>
                  <span
        ...
        <div className="ym-input-icon-rub ym-display-none">
            <input name="sum" placeholder="0.00" className="ym-input ym-sum-input ym-required-input" type="number" step="any" value="10000"/>
        </div>
